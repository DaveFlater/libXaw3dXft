...
## <a name="building"></a>Building a release
...
## <a name="gitsrc"></a>Building git sources
...
## <a name="linking"></a>Linking with libXaw3dXft
...
## <a name="version"></a>Version identification
...
## <a name="olddocs"></a>Old documentation
...
## <a name="newclasses"></a>Classes not present in Athena Widgets

### <a name="threed"></a>ThreeD
...
## <a name="alterations"></a>Alterations to Athena Widgets classes
...
### <a name="TextWidget"></a>Text, TextSink, TextSrc
...
## <a name="migration"></a>Version 1.x to 2.0 migration
